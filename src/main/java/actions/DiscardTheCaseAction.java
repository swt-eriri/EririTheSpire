...
public class DiscardTheCaseAction extends AbstractGameAction {
    public static final String[] TEXT;
    private AbstractPlayer player;
    private int numberOfCards;
    private boolean optional;

    public DiscardTheCaseAction(int numberOfCards, boolean optional) {
    ...
    public DiscardTheCaseAction(int numberOfCards) {
    ...
    static {
        TEXT = CardCrawlGame.languagePack.getUIString("DiscardTheCaseAction").TEXT;
    }
}

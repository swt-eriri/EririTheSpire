...
public class TwintailSpiralStrikeAction extends AbstractGameAction {
    ...
    public TwintailSpiralStrikeAction(AbstractPlayer p, int[] multiDamage, DamageType damageType, boolean freeToPlayOnce, int energyOnUse) {
